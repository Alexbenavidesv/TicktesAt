...
Route::get('llamarHoras', 'VisitasController@horasModulos');
...
Route::get('/filtrarc/','ContratosController@filtrarContratos')->middleware('auth','sesion','root');
Route::get('/modulos_contrato','ContratosController@modulos_contrato')->middleware('auth','sesion','root');
