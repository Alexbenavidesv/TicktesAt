...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main block-center">
	...
	<table class="table table-striped table-condensed" align="center" style="width: 100%">
		...
		@endif
			<td>
				<a type="button" href="#" class="btn btn-warning btn-sm" style="width: 30px" id="infoticket{{$t->id}}" onclick="vistaPrevia({{$t->id}})"><i class="fa fa-eye" aria-hidden="true"></i></a>
				<a type="button" href="#" class="btn btn-warning btn-sm" style="width: 30px; display:none" id="infoticket2{{$t->id}}" onclick="vistaPrevia2({{$t->id}})"><i class="fa fa-close" aria-hidden="true"></i></a>
			</td>
			<td>{{$t->id}}</td>
					@if($t->estado==0)
